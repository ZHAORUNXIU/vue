...
<template>
    ...
    <hr>
    <el-date-picker v-model="value" type="date" placeholder="Pick a day" :disabled-date="disabledDate" :shortcuts="shortcuts" />
    <hr>
</template>
...
import { ref } from "vue";
// import datePicker from "@/composibles/DatePicker.js";
import { value, shortcuts, disabledDate } from "@/composibles/DatePicker.js";
...
export default {
    ...
    // 此处可对比 HomePage.vue <script setup> 用法
    setup() {
        //此处非响应式
        // return { number: 2 }
        let number = ref(2);

        // 此处移到组合式API composible 文件夹下，独立的js文件里
        // const value = ref("");
        // const shortcuts = [
        //     {
        //         text: "Today",
